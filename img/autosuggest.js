	...
	elem.onkeyup = function(ev) {
		...
		default:
			...
			if (this.value != me.inputText && this.value.length > 0) {
                if(this.autosuggestTimeout!=undefined)
                    clearTimeout(this.autosuggestTimeout);
				this.autosuggestTimeout=setTimeout(function() {me.HTTPpreload();},1000);
			} else {
				me.hideDiv();
			}
		}
...
//    console.log(this.highlighted+':'+this.style.display);
		if (this.highlighted > -1) {
            ...
            if(this.autosubmit && (this.key==ENT || this.key==RET))
                this.form.submit();
//            this.form.submit();
	};
	...
	********************************************************/
	this.createDiv = function() {
		...
		********************************************************/
		...
		this.div.className="suggestion_list overlib hand";
        
    	this.div.style.position = this.form.name=='quicksearch' ? 'fixed' : 'absolute';
