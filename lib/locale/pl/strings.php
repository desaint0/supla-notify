 ...
 *  USA.
 *
 *  $Id: strings.php,v 1.355 2010/04/09 17:01:32 alec Exp $
 */
...
$_LANG['Customer Charging Edit: $a'] = 'Edycja zobowiązań klienta: $a';
...
$_LANG['Customer Information: $a'] = 'Informacje o kliencie: $a';
...
$_LANG['Enter time of settlement in HH:MM format (empty field means current time)'] = 'Wprowadź czas wystawienia w formacie GG:MM. Puste pole oznacza obecna godzinę';
...
$_LANG['Network/prefix (interface) [vlan]:'] = 'Sieć/prefiks (interfejs) [vlan]:';
...
$_LANG['Enter vlan id (optional)'] = 'Wpisz id vlanu w którym jest podsieć (opcjonalnie)';
$_LANG['new'] = 'nowy';
$_LANG['New:'] = 'Nowe:';
...
$_LANG['Hostname is invalid (two dots)'] = 'Nazwa hosta jest nieprawidłowa (dwie kropki)';
...
$_LANG['Subscription $a already exists!'] = 'Taryfa $a już istnieje!';
...
$_LANG['Phone line:'] = 'Linia telefonu:';
...
$_LANG['CLIR'] = 'CLIR';
$_LANG['ACREJ'] = 'ACREJ';
$_LANG['CLIR Override'] = 'Przełamanie CLIR';
$_LANG['CLIR allowed'] = 'Zezwalaj na CLIR';
$_LANG['ACREJ allowed'] = 'Zezwalaj na ACREJ';
$_LANG['DND'] = 'DND';
$_LANG['DND allowed'] = 'Zezwalaj na DND';
...
$_LANG['Call waiting allowed'] = 'Zezwalaj na połączenia oczekujące';
$_LANG['3-way calls'] = 'Połączenia trójstronne';
$_LANG['Wake-up calls'] = 'Budzenie';
...
$_LANG['CFNR'] = 'CFNR';
$_LANG['CFUR'] = 'CFUR';
$_LANG['Allow Fax2Mail forwarding'] = 'Zezwalaj na przekierowania Fax2Mail';
$_LANG['Allow Fax2Mail transfers'] = 'Zezwalaj na transfery Fax2Mail';
$_LANG['Fax2Mail'] = 'Fax2Mail';
$_LANG['Unconditional forward'] = 'Przekierowanie bezwarunkowe';
$_LANG['Forward when unreachable'] = 'Przekierowanie gdy nieosiągalny';
...
$_LANG['Select phone context'] = 'Wybierz grupe numeracyjną';
...
$_LANG['Select CLID tariff'] = 'Wprowadź taryfę numeru';
...
$_LANG['Select phone line'] = 'Wybierz profil telefonu';
$_LANG['Enter e-mail address'] = 'Wprowadź adres e-mail';
$_LANG['Select emergency context'] = 'Wybierz grupę numeracyjną połączeń alarmowych';
$_LANG['Enter phone device host name'] = 'Wprowadź nazwę hosta urządzenia';
...
$_LANG['Select to enable CLIR'] = 'Zaznacz aby włączyć zastrzeżenie prezentacji numeru';
$_LANG['Select to allow user to modify CLIR settings'] = 'Zaznacz aby zezwolić abonentowi na modyfikację ustawień prezentacji numeru';
...
$_LANG['Select to allow user to modify DND settings'] = 'Zaznacz aby zezwolić abonentowi na włączanie usługi \'nie przeszkadzać\'';
...
$_LANG['Select to enable Fax2Mail forwarding'] = 'Zaznacz aby zezwolić na przekierowania Fax2Mail';
$_LANG['Select to enable Fax2Mail transfers'] = 'Zaznacz aby zezwolić na transfery Fax2Mail';
...
$_LANG['telephone calls and subscribe'] = 'połączenia telefoniczne i abonament';
...
$_LANG['Enter absolute monthly cost limit'] = 'Wprowadź bezwzlędny miesięczny limit kosztów';
...
$_LANG['from the beginning'] = 'od daty aktywacji';
$_LANG['Commands'] = 'Polecenia';
$_LANG['last $a tickets'] = 'ostatnie $a zgłoszeń';
$_LANG['resignation'] = 'rezygacja';
$_LANG['answer to resignation'] = 'odpowiedź na rezygacje';
$_LANG['Enter device latitude (optional)'] = 'Podaj szerokość geograficzną dla urządzenia (N opcjonalne)';
$_LANG['Enter device longitude (optional)'] = 'Podaj długość geograficzną dla urządzenia (E opcjonalne)';
$_LANG['GPS coordinates:'] = 'Współrzędne geograficzne:';
$_LANG['GPS latitude:'] = 'Szerokość geo: (N)';
$_LANG['GPS longitude:'] = 'Długość geo: (E)';
...
$_LANG['Web:'] = 'Strona www:';
$_LANG['Enter web page'] = 'Wpisz stronę www';

$_LANG['MR_Submitter:'] = 'Rozmówca:';
$_LANG['MR Add new ticket'] = 'Dodanie nowego zdarzenia';
$_LANG['MR Are you sure, you want to remove ticket $a?'] = 'Jesteś pewien, że chcesz usunąć zdarzenie nr $a?';
$_LANG['MR Display tickets matching the following criteria:'] = 'Wyświetl zdarzenia pasujące do następujących kryteriów';
$_LANG['MR Enter ticker content'] = 'Wprowadź treść zdarzenia';
$_LANG['MR Enter ticket subject'] = 'Wprowadź temat zdarzenia';
$_LANG['MR New Ticket'] = 'Nowe zdarzenie';
$_LANG['MR No such tickets matching search criteria.'] = 'Brak zdarzeń spełniających warunki szukania.';
$_LANG['MR Only \'new\' ticket can be owned by no one!'] = 'Tylko nowe zdarzenia mogą być pozbawione właściciela!';
$_LANG['MR Tickets List'] = 'Lista zdarzeń';
$_LANG['MR Select ticket status'] = 'Wybierz status zdarzenia';
$_LANG['MR Select ticket uptime'] = 'Wybierz czas zdarzenia';
$_LANG['MR Select user/owner of the ticket'] = 'Wybierz użytkownika/właściciela zdarzenia';
$_LANG['MR Ticket date:'] = 'Data zdarzenia:';
$_LANG['MR Ticket Edit: $a'] = 'Edycja zdarzenia: $a';
$_LANG['MR Ticket History'] = 'Historia zdarzenia';
$_LANG['MR Ticket must have its body!'] = 'Zdarzenie musi mieć jakąś zawartość!';
$_LANG['MR Ticket must have its title!'] = 'Zdarzenie musi mieć tytuł!';
$_LANG['MR Ticket No. $a'] = 'Zdarzenie Nr $a';
$_LANG['MR Ticket Review'] = 'Podgląd zdarzenia';
$_LANG['MR Ticket Review: $a'] = 'Podgląd zdarzenia: $a';
$_LANG['MR Tickets'] = 'Zdarzenia';
$_LANG['MR Ticket Search'] = 'Wyszukiwanie zdarzeń';
$_LANG['MR Tickets searching'] = 'Wyszukiwanie zdarzeń';
$_LANG['MR Ticket No.'] = 'Nr zdarzenia';
$_LANG['MR Resolve ticket:'] = 'Rozwiąż zdarzenie:';
$_LANG['MR Previous ticket'] = 'Poprzednie zdarzenie';
$_LANG['MR Next ticket'] = 'Następne zdarzenie';
$_LANG['MR last $a tickets'] = 'ostatnie $a zdarzeń';
$_LANG['Display this form again, when this location is saved'] = 'Po dodaniu lokalizacji wyświetl ten formularz ponownie';

$_LANG['Debt level:'] = 'Poziom zadłużenia:';
$_LANG['indebted'] = 'zadłużony';
$_LANG['payment summons - to do'] = 'wezwanie - do wystawienia ';
$_LANG['payment summons - done'] = 'wezwanie - wystawione';
$_LANG['last payment summons - to do'] = 'ostateczne wezwanie - do wystawienia';
$_LANG['last payment summons - done'] = 'ostateczne wezwanie - wystawione';
$_LANG['contract termination - to do'] = 'rozwiązanie umowy - do wystawienia';
$_LANG['contract termination - done'] = 'rozwiązanie umowy - wystawione';
$_LANG['solicitor'] = 'radca prawny';
$_LANG['court'] = 'sąd';
$_LANG['bailiff'] = 'komornik';
$_LANG['ineffective'] = 'bezskuteczność';
$_LANG['settlement of debt'] = 'sprawy uregulowane';
$_LANG['Draw-up summons'] = 'Wystaw wezwanie';

$_LANG['Automessages'] = 'Automatyczne wiadomości';
$_LANG['Automessage Add'] = 'Automatyczne wiadomości - Dodawanie';
$_LANG['Automessage Edit'] = 'Automatyczne wiadomości - Edycja';
$_LANG['Current Attachment'] = 'Obecny załącznik';
$_LANG['communicate'] = 'komunikat';
$_LANG['Minutes'] = 'Minuty';
$_LANG['Hours'] = 'Godziny';
$_LANG['Days'] = 'Dni';
$_LANG['Months'] = 'Miesiące';
$_LANG['Days of the week'] = 'Dni tygodnia';
$_LANG['Message'] = 'Wiadomość';
$_LANG['Sum'] = 'Suma';
$_LANG['State'] = 'Stan';
$_LANG['Download Attachment'] = 'Pobierz załącznik';
$_LANG['Disabled'] = 'Wyłączony';
$_LANG['Enabled'] = 'Włączony';
$_LANG['No automessages in database'] = 'Nie ma automatycznych wiadomości w bazie danych';
$_LANG['Message Type'] = 'Typ wiadomości';
$_LANG['warning'] = 'ostrzeżenie';
$_LANG['Nothing'] = 'Nic';
$_LANG['Automessages Logs'] = 'Automatyczne wiadomości - Plik logów';
$_LANG['Log file'] = 'Plik logów';
$_LANG['List of Automessages'] = 'Lista automatycznych wiadomości';
$_LANG['payment'] = 'wpłata';
$_LANG['else'] = 'coś innego';
$_LANG['Event'] = 'Zdażenie';
$_LANG['Value is not numeric!'] = 'Wartość nie jest liczbą!';
$_LANG['A message that will be send to indebted customer via e-mail.'] = 'Wiadomość wysyłana do zadłużonych użytkowników mailem';
$_LANG['A message that will be send to indebted customer via sms.'] = 'Wiadomość wysyłana do zadłużonych użytkowników w sms';
$_LANG['A message that will be send to customer with new payment via e-mail.'] = 'Wiadomość wysyłana do użytkowników z nową wpłatą mailem';
$_LANG['A message that will be send to customer with new payment via sms.'] = 'Wiadomość wysyłana do użytkowników z nową wpłatą w sms';
$_LANG['A message that will be send to customer with new invoice via e-mail.'] = 'Wiadomość wysyłana do użytkowników z nową faktura mailem';
$_LANG['A message that will be send to customer with new invoice via sms.'] = 'Wiadomość wysyłana do użytkowników z nową faktura w sms';
...
$_LANG['Select password expiration period (days), 0 - never expire'] = 'Ustal czas po którym hasło wygasa (w dniach), 0 - nigdy nie wygasa';
$_LANG['Last password change:'] = 'Ostatnia zmiana hasła:';
$_LANG['Never'] = 'Nigdy';
$_LANG['Servicetime'] = 'Czas realizacji';
...
$_LANG['netdevnode payments'] = 'opłaty za węzły (nadajniki)';
$_LANG['backup access forbidden'] = 'brak dostępu do kopii zapasowych';
$_LANG['Enter invoice remarks (optional)'] = 'Wpisz uwagi do faktury (opcjonalnie)';
...
$_LANG['Show/hide deleted'] = 'Pokaż/ukryj usuniętych';

$_LANG['AJAX: Error during persistent setting save on server:'] = 'AJAX: Błąd podczas zapisu trwałego ustawienia na serwerze:';
$_LANG['Enter new nagios template name'] = 'Wprowadź nazwę nowej templatki nagiosa';
